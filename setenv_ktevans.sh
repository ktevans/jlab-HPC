...
# Required by all
export SCRIPT_DIR=/work/halla/sbs/ktevans/jlab-HPC

# Required by the scripts running G4SBS or LIBSBSDIG jobs
export G4SBS=/work/halla/sbs/ktevans/g4sbs/install

# Required by the scripts running SIMC (simc_gfortran) jobs
export SIMC=/work/halla/sbs/ktevans/simc_gfortran

# Required by the scripts running digitization jobs using sbsdig
export LIBSBSDIG=/work/halla/sbs/ktevans/libsbsdig/install

# Required by the scripts running replay (data or MC) jobs
# $ANALYZER not needed while using modulefiles (See above)
#export ANALYZER=/work/halla/sbs/ktevans/sbsoffline/install
export SBSOFFLINE=/work/halla/sbs/ktevans/sbsoffline/install
export SBS_REPLAY=/work/halla/sbs/ktevans/sbsoffline/SBS-replay
